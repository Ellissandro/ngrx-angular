...
export const getUsersSuccess = createAction(GET_USERS_SUCCESS, props<{ user: User }>());
export const addUser = createAction(ADD_USER, props<{ user: User }>());
export const addUserSuccess = createAction(ADD_USERS_SUCCESS, props<{ user: User }>());
export const deleteUser = createAction(DELETE_USER, props<{ id: string }>());
export const searchUsers = createAction(SEARCH_USER, props<{ search: string }>());